...
import 'org_event_management.dart';
...
class _OrgDashboardState extends State<OrgDashboard> {
                      ...
                      GestureDetector(
                        onTap: () async {
                          ...
                          if (result != null && result is Map<String, dynamic>) {
                            ...
                            _saveData(); // Save these changes to persist them
                          }
                        },
                        child: CircleAvatar(
                          radius: 30,
        ...
        children: [
          Row(
            ...
            children: [
              ...
              TextButton.icon(
                ...
                label: Text(
                  _calendarFormat == CalendarFormat.month ? 'Week View' : 'Month View',
                  style: TextStyle(
                    color: const Color(0xFF071D99),
                    fontWeight: FontWeight.w500,
                  ),
              ...
              children: [
                TableCalendar(
                  ...
                  headerStyle: HeaderStyle(
                    ...
                    leftChevronIcon: const Icon(Icons.chevron_left, color: Color(0xFF071D99)),
                    rightChevronIcon: const Icon(Icons.chevron_right, color: Color(0xFF071D99)),
                  ),
                ),
                const Divider(),
                // Calendar legend and upcoming events summary
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          _buildCalendarLegendItem('Today', const Color(0xFFD7A61F)),
                          const SizedBox(width: 16),
                          _buildCalendarLegendItem('Selected Day', const Color(0xFF071D99)),
                          const SizedBox(width: 16),
                          _buildCalendarLegendItem('Has Events', Colors.grey),
                        ],
                      ),
          ...
          Align(
            ...
            child: TextButton.icon(
              onPressed: () {
                // Navigate to full calendar view page
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const OrgEventManagementPage()),
                );
              },
              icon: const Icon(Icons.calendar_month, color: Color(0xFF071D99)),
              label: Text(
                'View Full Calendar',
                style: TextStyle(
                  color: const Color(0xFF071D99),
  ...
  Widget _buildUpcomingEventsPreview() {
    // Get upcoming events for this month
    final now = DateTime.now();
    final endOfMonth = DateTime(now.year, now.month + 1, 0);
    
    final upcomingEvents = activities
        .where((activity) => 
          activity.date.isAfter(now) && 
          activity.date.isBefore(endOfMonth))
        .toList();
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Container(
            ...
            child: InkWell(
              onTap: () => _showEventsBottomSheet(event.date),
              child: Padding(
  ...
  Widget _getPageForItem(String title) {
    switch (title) {
      ...
      case 'Event Management':
        return const OrgEventManagementPage();
